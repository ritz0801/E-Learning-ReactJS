                ...
                <div className="footer_container container">
                        ...
                        <div className="col-md-4 col-sm-12 col-xs-12 mt-3">
                            <div className="row justify-content-around">
                                <div className="col-xs-6 mr-4 text-center hideOnMobile">
                                    ...
                                    <a target="_blank" rel="noopener noreferrer" href="https://github.com/ritz0801" className="mr-2">
                                        <img className="iconPartner" src={apple_logo} alt="" />
                                    </a>
                                    <a target="_blank" rel="noopener noreferrer" href="https://github.com/ritz0801">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-9 col-sm-12 col-xs-12">
                            <p className="pProductOf">E-Learning – Võ Anh Dũng</p>
                            <p className="pAddressAndTax mb-4">N17DCCN023</p>
                        </div>

                        <div className="col-md-2 col-sm-12 col-xs-12 text-right">
                            <a target="_blank" rel="noopener noreferrer" href="https://github.com/ritz0801" title="Bộ Công Thương">
