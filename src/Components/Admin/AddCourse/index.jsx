            ...
            {activeStep === 0 ? (
                <Formik
                    initialValues={{
                        ...
                        moTa: '',
                        hinhAnh: '',
                        taiKhoanNguoiTao: userLocalStorageParse.taiKhoan,
                        maDanhMuc: '',
                    }}
                    ...
                    render={(formikProps) => {
                        return <Form >
                            ...
                            <div className="form-group">
                                ...
                                <Field id="taiKhoanNguoiTao" type="text" className="form-control" name="taiKhoanNguoiTao" readOnly value={userLocalStorageParse.taiKhoan} />
